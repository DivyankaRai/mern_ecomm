...
const AdminPanel = () => {
  ...
  const getTodos = () => {
    ...
    axios
      .get(`https://nykkabackend-cgkg.onrender.com/products?search=${filters.search}&category=${filters.category}&sort=${filters.sort}`)
      .then((res) => {
  ...
  const deleteProduct = async (id) => {
    try {
      await axios.delete(`https://nykkabackend-cgkg.onrender.com/delete/product/${id}`, {
